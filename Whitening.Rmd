...
```{r}
fonction_arima_variable<-function(coeurs,nom_variable,p,q,P,D,Q,S){
  ...
  if(nom_variable=="S"){
    ...
    write.csv(x =Obs_nouveau,file = paste0("residuals/",nom_variable,"_residus.csv"))
  ...
  return(list("df"=df_time_variable,
...
Result_AR1<-fonction_arima_variable(coeurs = coeurs,nom_variable = nom_variable,P=p_sar,Q=0,D=0,p=0,q=0,S=S)
```
