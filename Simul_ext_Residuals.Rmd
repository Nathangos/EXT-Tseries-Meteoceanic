...
```{r}
Simulation_ACP_TS_EXT<-function(coeurs,NB_dim_ACP,lien_donnees,nom_variable,p_U,p_L2,n.dens,opt_Frech,M,std_donnees){
...
l_donnees<-paste0("residuals/",nom_variable,"_residuals.csv")
STD_donnees<-TRUE
P_U<-rep(0.10,37)
PL2<-0.05
NB_scores<-3
