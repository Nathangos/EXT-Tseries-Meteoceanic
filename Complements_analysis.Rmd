...
value_cov_sim
write.csv(value_cov,
          file = "Univariate_whitening/residus_clust/Mat_cov_data.csv")
write.csv(value_cov_sim,
          file = "Univariate_whitening/residus_clust/Mat_cov_sim.csv")
...
write.csv(Mat_indep_matrix,
          file = "Univariate_whitening/residus_clust/Mat_indep_matrix.csv")
M<-2000
...
write.csv(Sort_df,file = "Univariate_whitening/residus_clust/Sumy_copules.csv")
...
write.csv(Sort_df2,file = "Univariate_whitening/residus_clust/Sumy_copules_second.csv")
...
png(filename = paste0("Univariate_whitening/graphiques_Surcote/compar_data_copula_",
...
png(filename = paste0("Univariate_whitening/graphiques_Surcote/compar_data_copula_",Copula_chosen,
                      ".png"),
    width=1400,height=500)
par(mfrow=c(1,2),
    mar=c(5.5, 5.5, 5.5,5.5))
