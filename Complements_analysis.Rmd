...
All_exts
ggsave(filename =paste0("Graphics/Shape_parameter_",Name_v,"_TS.png"),plot = All_exts,width = 12,height = 5)
```
...
ggsave(paste0("Graphics/exs_",Name_v,".png"),
       plot = All_orig_ext,
       width=12,
       height=7)
```
...
ggsave(filename = paste0("Graphics/theta_coords_",Name_v,"_all.png"),
       plot = All_PCA_coords,
       width = 12,
       height = 9)
```
